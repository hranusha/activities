<x-admin.wrapper>
    ...
    <x-admin.add-link href="{{ route('admin.user.activity.create', $user->id ) }}">
        {{ __('Add Activity') }}
    </x-admin.add-link>
            ...
            <x-admin.grid.table>
                ...
                @foreach($activities as $activity)
                    <tr>
                        ...
                        <x-admin.grid.td>
                            <form action="{{ route('admin.user.activity.destroy', [ $user->id, $activity->id]) }}" method="POST">
                                <div>
                                    <a href="{{route('admin.user.activity.edit', [$user->id, $activity->id])}}" class="btn btn-square btn-ghost">
